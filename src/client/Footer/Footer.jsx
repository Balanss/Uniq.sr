...
export default function Footer() {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    ...
    <div
      className="mt-16 border-t bpt-8 sm:flex sm:items-center sm:justify-between lg:mt-24 border-gray-800"
    >
      ...
      <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
        <li>
          <a
            ...
            rel="noreferrer"
            target="_blank"
            className=" transition hover:opacity-75 text-gray-200 border-animation"
          >
